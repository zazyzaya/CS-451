...
public class J2_7_Sphere_iking extends J2_6_Cylinder_iking {
	...
	private void subdivideSphere(
		...
		if (depth==0) {
			float[] color = {v1[0]*v1[0], v2[1]*v2[1], v3[2]*v3[2]};
			prepareToDrawTriangle(v1, v2, v3, color);
			return;
		}
		for (i = 0; i<3; i++) {
			v12[i] = v1[i]+v2[i];
	...
	public static void main(String[] args) {
		J2_7_Sphere_iking f = new J2_7_Sphere_iking();
